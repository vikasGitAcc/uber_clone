...
router.post("/register",
    [
        ...
        body("vehicle.color").isLength({min:3}).withMessage("Color should be at least 3 char long"),
        body("vehicle.plate").isLength({min:3}).withMessage("plate should be at least 3 char long"),
